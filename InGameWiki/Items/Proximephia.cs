...
namespace EastsFishing.InGameWiki.Items
{
	public class Proximephia : ModItem
	{
		public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Fishing Guide");
			Tooltip.SetDefault("Left click on East's Fishing Extension's NPCs to learn information about them\nRight-click to clear the chat");
        }

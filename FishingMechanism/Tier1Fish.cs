	...
	public class Tier1Fish : ModNPC
	{
		...
		public override float SpawnChance(NPCSpawnInfo spawnInfo)
		{
			for (int i = 0; i < 1; ++i)
		    {
				...
				{
				    return SpawnCondition.WaterCritter.Chance * 660;	
				}
				else
				{
				    return SpawnCondition.WaterCritter.Chance * 600;
				}
			}
			return SpawnCondition.WaterCritter.Chance * 600;
		}
		...
		for (int i = 0; i < 1; ++i)
		{
            ...
            {
                NPC.NewNPC((int)(npc.position.X), (int)(npc.position.Y), (mod.NPCType("Tier2Fish")));
            }
        }			
		}
	}

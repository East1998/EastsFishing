...
{
	public class JourneymanFood : ModItem
	{
		public override void SetDefaults()
		{
			...
			item.shootSpeed = 9f;
			item.shoot = mod.ProjectileType("JourneymanFoodProjectile");
		}
        ...
        {
            DisplayName.SetDefault("Journeyman Food Bottle");
			Tooltip.SetDefault("Throws a journeyman bait to attract fishes every 5 seconds\nOnly one bait can be used at a time\nRight-click to destroy existing baits\nBaits won't work outside the water");
        }
		public override void AddRecipes()
		{
		    ModRecipe recipe = new ModRecipe(mod);
            recipe.AddIngredient(2675, 20);

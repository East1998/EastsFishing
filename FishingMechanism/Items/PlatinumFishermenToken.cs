...
{
	public class PlatinumFishermenToken : ModItem
	{
		public override void SetDefaults()
		{
			...
			item.shootSpeed = 9f;
			item.shoot = mod.ProjectileType("PlatinumFishermenTokenProjectile");
		}

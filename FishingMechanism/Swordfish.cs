...
namespace EastsFishing.FishingMechanism
{
	public class Swordfish : ModNPC
	{
        ...
        public override void HitEffect(int hitDirection, double damage)
		{
			if (npc.life <= 0)
            {
                Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/SwordfishGore1"), 1f);
                Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/SwordfishGore2"), 1f);
            }
		}
